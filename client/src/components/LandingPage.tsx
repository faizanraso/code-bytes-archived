    ...
    return(
        <div className="landing-page-div">
            ...
            <div className="text-center mx-auto my-20 md:mt-32 lg:mt-48 max-w-xl">
                ...
                <p className="opacity-80 text-[#939393] text-lg leading-8 md:text-xl mb-8">Use our in-browser IDE to collaborate with others and develop amazing things, for free!</p>
